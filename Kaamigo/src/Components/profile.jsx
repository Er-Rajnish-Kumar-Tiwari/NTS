        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-white p-6 rounded-lg shadow text-center">
              ...
              />
              <h2 className="font-bold text-lg text-orange-500">Sarah Chen</h2>
              <p className="text-sm text-gray-600">Graphic Designer</p>
              <div className="flex justify-center gap-5 mt-4 text-sm text-gray-500">
                <div>
              ...
              <button
                onClick={handleBook}
                className="mt-4 bg-purple-500 text-white w-full py-2 rounded hover:bg-purple-600"
              >
                {isBooked ? "Booked!" : "Book Session"}
              </button>
              <button
                onClick={handleMessage}
                className="mt-2 border w-full py-2 rounded text-purple-500 hover:bg-purple-100"
              >
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-2 gap-4 text-sm">
                {[
                  ...
                  <div
                    key={title}
                    className="border p-5 rounded-lg text-center bg-white shadow-sm"
                  >
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
                {Array(8)
                  ...
                  .map((_, i) => (
                    <div
                      key={i}
                      className="bg-gray-100 h-32 rounded flex items-center justify-center text-sm text-gray-500"
                    >
                      Project {i + 1}
                    </div>
                  ))}
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <div className="grid sm:grid-cols-2 gap-4 text-sm">
                {["Alice Johnson", "Bob Williams"].map((client, i) => (
                  <div key={client} className="border p-5 rounded space-y-2">
                    <p>
                      {i === 0
